...
#### 1. Model Comparison
![Model Comparison](PROJECT/visualization/outputs/model_comparison.png)

#### 2. Actual vs Predicted Yield
![Actual vs Predicted Yield](PROJECT/visualization/outputs/actual_vs_predicted.png)

#### 3. Residual Analysis
![Residual Analysis](PROJECT/visualization/outputs/residuals.png)

#### 4. Feature Correlation EDA
![Correlation Heatmap](PROJECT/visualization/outputs/correlation_heatmap.png)
